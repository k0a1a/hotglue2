...
(function() {
	...
	var draw = function() {
		// the offscreen feeder's autoplay attribute is not always enough
		// (policy differences between engines) - the tiler asks for
		// playback itself, muted so it is always allowed
		if (video.paused) {
			video.play();
		}
