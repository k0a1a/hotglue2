...
function object_background_section(pop, icons, body, obj, save)
{
	...
	// The glyph is the shared color-26, the same as the page panel's and
	// every other colour button in the editor (danja's call, 09-16).
	var colour = $.glue.popover.icon_button('color-26', 'set object background color');
