...
// Exercise the real sources by default, not whatever .min.js pair happens to be
// stale. HG_MIN=1 flips it, so the suite can also be run against the minified
// copies - which is what a DEFAULT install serves, USE_MIN_FILES being true in
// config.inc.php. Worth doing for js/mobile-guided.js in particular: it is the
// only script a visitor to a published page loads, and its copy is generated by
